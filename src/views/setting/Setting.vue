            ...
            for (let j = 0; j < thisItem.children.length; j++) {
              ...
              if( thisSubItem.functionType != 3) {
                ...
                if (thisSubItem.url) {
                  self.ablePick.push({
                    key: key,
                    label: thisSubItem.resourceName,
                    cp: thisSubItem.url,
                    icon: thisItem.icon
                  })
                  key++
                  ...
                  for (let l = 0; l < thisSubItem.children.length; l++) {
                    ...
                    self.ablePick.push({
                      key: key,
                      label: thisSubSubItem.resourceName,
                      cp: thisSubSubItem.url,
                      icon: thisItem.icon
                    })
                    key++
                  }
                ...
                for (let k = 0; k < thisSubItem.children.length; k++) {
                  ...
                  if (thisSubSubItem.url) {
                    ...
                    for (let l = 0; l < thisSubSubItem.children.length; l++) {
                      ...
                      self.ablePick.push({
                        key: key,
                        label: thisSubSubSubItem.resourceName,
                        cp: thisSubSubSubItem.url,
                        icon: thisItem.icon
                      })
                      key++
                    }
